...
initial_label = ...        ## labels you try in a list. if you want labels following themselves: range(initial,final) or range(len(label))
######################################################################################################################################

prediction_df = table_for_predictions(train_prediction, initial_label, False )
accuracy = score_all_labels(label_table,prediction_df, initial_label)
print(accuracy)
makeplot(initial_label,accuracy,False)
